...
public class EmployeeController {
	...
	public static void main(String[] args) {
		...
		Employee emp1=empObj.getEmployeeById(10);
		emp1.setName("sanju");
		empObj.updateEmployee(emp1);
		//empObj.updateEmployee(empObj.getEmployeeById(10));
		// empObj.deleteEmployee(empObj.getEmployeeById(100));
